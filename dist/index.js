...
const axios_1 = __importDefault(__nccwpck_require__(7437));
class NetlifyClient {
...
const logic_1 = __nccwpck_require__(8366);
const NetlifyClient_1 = __importDefault(__nccwpck_require__(4202));
...
const getLatestDeployID = (core, deploys) => {
    const latestDeploy = deploys.find((deploy) => deploy.context === "production" && deploy.state === "ready");
    if (!latestDeploy) {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(2012);
